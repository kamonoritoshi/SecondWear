...
const HomeIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8h5z"></path></svg>
);
const StoreIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L1 9l4 12h14l4-12L12 2zm6 17H6.5l-3-9L12 4.5l8.5 5.5-3 9zM12 11c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"></path></svg>
);
const PolicyIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"></path></svg>
);
const TermsIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6z"></path></svg>
);
const ReturnIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"></path></svg>
);
const ShippingIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm11-6H6.83l1.58-3.37L17 12zM18 18c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"></path></svg>
);
const PaymentSecurityIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1s3.1 1.39 3.1 3.1v2z"></path></svg>
);
const FaqIcon = (props) => (
...
const InfoIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"></path></svg>
);
const ContactIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
);
const BusinessIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10z"></path></svg>
);
const RecruitIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V18c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-1.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V18c0 .55.45 1 1 1h2c.55 0 1-.45 1-1v-1.5c0-2.33-4.67-3.5-7-3.5z"></path></svg>
);
const BlogIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2v-2h2v2zm0-4H7v-2h10v2zm0-4H7V7h10v2z"></path></svg>
);
...
const Header = ({ t, currentTheme, setTheme, handleLanguageChange }) => {
  ...
  const menuData = [
    {
      items: [
        { labelKey: "menu_home", label: "Trang chủ", to: "/", icon: <HomeIcon /> },
        { labelKey: "menu_products", label: "Sản phẩm", to: "/products", icon: <StoreIcon /> },
      ],
    },
    {
      ...
      title: "Chính sách",
      items: [
        { labelKey: "menu_policy_privacy", label: "Chính sách bảo mật", to: "/privacy-policy", icon: <PolicyIcon /> },
        { labelKey: "menu_policy_terms", label: "Điều khoản sử dụng", to: "/terms-of-use", icon: <TermsIcon /> },
    ...
    },
    {
      ...
      items: [
        { labelKey: "menu_legal_about", label: "Công bố doanh nghiệp", to: "/about-us", icon: <BusinessIcon /> },
        { labelKey: "menu_legal_careers", label: "Tuyển dụng", to: "/careers", icon: <RecruitIcon /> },
        { labelKey: "menu_legal_blog", label: "Blog", to: "/blog", icon: <BlogIcon /> },
      ],
    },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "11.5px 4px 11.5px 16px", display: "flex", alignItems: "center", flexShrink: 0 }}>
              <button
                className="tray-toggle-btn"
                style={{
                  background: "none",
            ...
            <div style={{ padding: '12px 0' }}>
              {menuData.map((section, sectionIndex) => (
                <div key={sectionIndex}>
                  {section.title && <h3 className="menu-section-title">{t(section.titleKey) || section.title}</h3>}
                  <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
                    {section.items.map((item, itemIndex) => (
                      <li key={itemIndex}>
                        <Link to={item.to} className="tray-menu-link" onClick={() => setTrayOpen(false)}>
                          {item.icon}
                  ...
                  {sectionIndex < menuData.length - 1 && <hr className="menu-divider" />}
                </div>
              ))}
            </div>
          </nav>
          ...
          <div className="header-icons" ref={dropdownRef}>
            ...
            >
              <button
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 6, fontWeight: 600, background: 'none', border: 'none', cursor: 'pointer', padding: '6px 10px', borderRadius: 8 }}
              >
                <img src={currentTheme === "dark" ? whiteUser : blackUser} alt="User" className="header-icon" />
                <span className="user-text" style={{ color: 'var(--main-text)' }}>{isAuthenticated ? currentUser.name || currentUser.email : t("guest_label")}</span>
              </button>
              {openDropdown === 'account' && (
                <div
                  className="dropdown-menu"
                  style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, minWidth: 170, background: 'var(--dropdown-bg)', boxShadow: '0 6px 24px rgba(0,0,0,0.13)', borderRadius: 12, padding: '12px 0', zIndex: 10 }}
                >
                  {isAuthenticated ? (
                    <>
                      <Link
